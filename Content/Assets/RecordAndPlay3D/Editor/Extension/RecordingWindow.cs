...
namespace RecordAndPlay.Editor.Extension
{
    ...
    internal class RecordingWindow : EditorWindow
    {
            ...
            if (currentRecordingMethod == RecordingMethod.Recorder)
            {
                ...
                switch (recorder.CurrentState())
                {
                    case RecordingState.Stopped:
                        ...
                        {
                            recorder.Start();
                            timeStartedRecording = UnityEngine.Time.realtimeSinceStartup;
                        }
                        break;
        ...
        private void RenderCurrentlyRecordingSection()
        {
            ...
            EditorGUILayout.LabelField(string.Format("{0:0.00}", UnityEngine.Time.realtimeSinceStartup - timeStartedRecording), centerStyle);
        }
