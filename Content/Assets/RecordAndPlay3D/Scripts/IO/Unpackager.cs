...
namespace RecordAndPlay.IO
{
    ...
    public static class Unpackager
    {
        ...
        /// </summary>
        /// <param name="path">The path to the file containing the recording(s).</param>
        /// <returns>Recordings found in the file specified.</returns>
        ...
        public static CustomEventCapture[] FromTransport(Google.Protobuf.Collections.RepeatedField<Transport.CustomEventCapture> transportCapture)
        {
